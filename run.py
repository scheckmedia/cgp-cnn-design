...
function_mapping = {
    ...
    'dw_3x3_stride_2': {'cls': DepthwiseConv2D, 'args': {'kernel_size': 2, 'strides': 2}, 'inputs': 1},
    'dw_3x3_stride_2': {'cls': DepthwiseConv2D, 'args': {'kernel_size': 2, 'strides': 2}, 'inputs': 1},
    'dw_3x3_stride_2': {'cls': DepthwiseConv2D, 'args': {'kernel_size': 2, 'strides': 2}, 'inputs': 1},
...
if __name__ == '__main__':
    trainer = Cifar10Trainer(batch_size=128, epochs=150, verbose=1, lr=[0.1, 0.005, 0.001, 0.0005, 0.0001])
